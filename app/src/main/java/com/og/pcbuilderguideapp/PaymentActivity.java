...
import com.og.pcbuilderguideapp.models.CreateOrderDTO;
import com.og.pcbuilderguideapp.models.CreateOrderItemDTO;
...
import com.og.pcbuilderguideapp.models.SimpleCartItem;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    public void updateTotalPrice() {
        ...
        tvTotalPaymentPrice.setText("Tổng giá " + String.format("%,.2f", total) + "VND");
    }
    ...
    private void createOrderWithPaymentMethod(String paymentMethod) {
        ...
        RetrofitClient.getInstance(this)
            ...
            .enqueue(new Callback<com.og.pcbuilderguideapp.models.Order>() {
                @Override
                public void onResponse(Call<com.og.pcbuilderguideapp.models.Order> call, Response<com.og.pcbuilderguideapp.models.Order> response) {
                ...
                @Override
                public void onFailure(Call<com.og.pcbuilderguideapp.models.Order> call, Throwable t) {
                    progressDialog.dismiss();
